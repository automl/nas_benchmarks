...
from hpbandster.optimizers.single_bnns import SingleBNNs
...
output_path = os.path.join(args.output_path, "single_bnns")
...
bohb = SingleBNNs(configspace=cs,
            run_id=hb_run_id,
            eta=3, min_budget=min_budget, max_budget=max_budget,
            nameserver=ns_host,
            nameserver_port=ns_port,
            ping_interval=10, fully_dimensional=True,
            min_points_in_model=10, top_n_percent=5, min_bandwidth=1e-1)
